...
declare module Chroma {
    ...
    export interface ChromaStatic {
        ...
        temperature(value: number): Color;
    ...
    export interface Color {
         ...
         */
        luminance(): number;
        luminance(value, mode?: string): number;
        ...
        get(s: string): number | number[];

        set(s: string, n: number): Color;
        set(s: string, p: string): Color;
    ...
    export interface Scale {
        ...
        classes(breaks: number | number[]): Scale;
    }
